...
public class InMemoryTaskManagerTests {
    ...
    public void testAddAndGetTasksByType() {
        ...
        Subtask subtask = new Subtask("Подзадача 1", "Описание подзадачи 1", Duration.ZERO, LocalDateTime.MAX, 1);
    ...
    public void testNoConflictBetweenKnownAndGeneratedId() {
        ...
        Task knownIdTask = new Task("Задача с известным ID", "Описание задачи", Duration.ZERO, LocalDateTime.MAX);
        ...
        Task autoGeneratedTask = new Task("Задача с сгенерированным ID", "Еще одно описание", Duration.ZERO, LocalDateTime.MAX);
    ...
    public void testTaskRemainsUnchangedAfterAdding() {
        ...
        Task originalTask = new Task("Оригинальная задача", "Описание задачи", Duration.ZERO, LocalDateTime.MAX);
